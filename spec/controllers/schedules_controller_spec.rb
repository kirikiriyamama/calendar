...
describe SchedulesController do
  ...
  let(:valid_attributes) { { "deadline_at" => "2013-05-16 01:49:34" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved schedule as @schedule" do
        ...
        post :create, {:schedule => { "deadline_at" => "invalid value" }}, valid_session
        assigns(:schedule).should be_a_new(Schedule)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested schedule" do
        ...
        Schedule.any_instance.should_receive(:update_attributes).with({ "deadline_at" => "2013-05-16 01:49:34" })
        put :update, {:id => schedule.to_param, :schedule => { "deadline_at" => "2013-05-16 01:49:34" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the schedule as @schedule" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Schedule.any_instance.stub(:save).and_return(false)
        put :update, {:id => schedule.to_param, :schedule => { "deadline_at" => "invalid value" }}, valid_session
        assigns(:schedule).should eq(schedule)
      end
